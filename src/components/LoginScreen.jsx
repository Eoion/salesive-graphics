        ...
        <div style={{
          ...
          <button 
            ...
            style={{
              ...
              width: '100%',
              padding: '12px 20px',
              background: loginLoading ? 'var(--bg-hover)' : 'var(--text-primary)',
              color: loginLoading ? 'var(--text-muted)' : 'var(--bg-base)',
              border: 'none',
              borderRadius: 12,
              fontSize: 14,
              fontWeight: 600,
            ...
            onMouseDown={e => !loginLoading && (e.currentTarget.style.transform = 'scale(0.98)')}
            onMouseUp={e => !loginLoading && (e.currentTarget.style.transform = 'scale(1)')}
          >
            {loginLoading ? (
              <>
                <div style={{
