...
export default function SVGCanvas({
    ...
    useEffect(() => {
        ...
        const observer = new ResizeObserver(() => {
            ...
            setScale(
                Math.min(width / svgSize.width, height / svgSize.height) * 0.9,
            );
            setFitted(true);
        });
    ...
    useEffect(() => {
        ...
        const t = setTimeout(() => {
            try {
                setSelectedRect(getRectRelative(el, containerRef.current));
            } catch {
                setSelectedRect(null);
            }
        }, 60);
                        ...
                        >
                            ...
                            >
                                ...
                                {hoverNode.text && (
                                    ...
                                    >
                                        "{hoverNode.text.slice(0, 18)}
                                        {hoverNode.text.length > 18 ? "…" : ""}"
                                    </span>
                                )}
                            ...
                            return (
                                <div
                                    ...
                                    style={{
                                        ...
                                        height: r.height,
                                        outline:
                                            "1px dashed rgba(13,101,217,0.35)",
                                        pointerEvents: "none",
                                        zIndex: 15,
                                    }}
                                >
